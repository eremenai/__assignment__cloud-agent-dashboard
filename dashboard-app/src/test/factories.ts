...
export function createSessionWithMetrics(
	overrides: Partial<SessionWithMetrics> = {},
): SessionWithMetrics {
...
export function createHandoff(
	overrides: Partial<LocalHandoffEvent> = {},
): LocalHandoffEvent {
	return {
...
export function createUserWithMetrics(
	overrides: Partial<UserWithMetrics> = {},
): UserWithMetrics {
