...
export default function UserDetailPage({ params }: UserDetailPageProps) {
  ...
  }, [resolvedParams.id, from, to, setMetadata, clearMetadata]);
  ...
  return (
    <div className="@container/main space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <UserSessionsTable sessions={sessions} userId={resolvedParams.id} userName={data.user.name} />
        </CardContent>
      </Card>
    </div>
  );
