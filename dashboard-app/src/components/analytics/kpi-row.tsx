...
const columnClasses = {
  ...
  6: "grid-cols-1 @xl/main:grid-cols-2 @3xl/main:grid-cols-3 @5xl/main:grid-cols-6",
  7: "grid-cols-1 @xl/main:grid-cols-2 @3xl/main:grid-cols-4 @5xl/main:grid-cols-7",
};
